...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo $base_url2;?>plugins/iCheck/square/blue.css">
        <style>
            .mi-input::placeholder { color: #21618c  ; font-weight: bold; }
        </style>
    </head>
    <body background ='<?php echo $base_url2;?>dist/img/fondo.jpg' >

    
        <br>
          <section class = "container" >
         <center><img style = "width: 550px;" src = "<?php echo $base_url2;?>dist/img/principal.png">
            </center>
        ...
        <script src = "<?php echo $base_url2;?>plugins/jQuery/jquery-2.2.3.min.js"></script>
        <script src="<?php echo $base_url2;?>bootstrap/js/bootstrap.min.js"></script>
        <script src="<?php echo $base_url2;?>plugins/iCheck/icheck.min.js"></script>
